                    ...
                    <div class="card-body">
                        <form action="{{ route('barangmasuk.update',$rsetBarangMasuk->id) }}" method="POST" enctype="multipart/form-data">                    
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control @error('tgl_masuk') is-invalid @enderror" name="tgl_masuk" value="{{ old('tgl_masuk',$rsetBarangMasuk->tgl_masuk) }}" placeholder="Masukkan Tgl Masuk">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('qty_masuk') is-invalid @enderror" name="qty_masuk" value="{{ old('qty_masuk',$rsetBarangMasuk->qty_masuk) }}" placeholder="Masukkan Qty">
